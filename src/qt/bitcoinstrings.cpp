...
"for example: alertnotify=echo %%s | mail -s \"FerretCoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
"27000)"),
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the FerretCoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. FerretCoin is shutting down."),
