...
bool AddressTableModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case Label:
            ...
            {
                wallet->SetAddressBookName(CFerretCoinAddress(strTemp).Get(), value.toString().toStdString());
            }
            break;
        case Address:
            ...
            if(CFerretCoinAddress(rec->address.toStdString()) == CFerretCoinAddress(value.toString().toStdString()))
            {
                editStatus = NO_CHANGES;
                return false;
            }
            ...
            else if(wallet->mapAddressBook.count(CFerretCoinAddress(value.toString().toStdString()).Get()))
            {
...
{
    {
        ...
        {
            CFerretCoinAddress address_parsed(sAddr);
