...
{
    columns << QString() <<  QString() << tr("Date") << tr("Type") << tr("Address") << FerretCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
	columns[Amount] = FerretCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
