...
int nAnonymizeFerretCoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\FRTC
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\FRTC
    // Mac: ~/Library/Application Support/FRTC
    // Unix: ~/.FRTC
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FRTC";
#else
    fs::path pathRet;
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDataDir() / "FerretCoin.conf";
